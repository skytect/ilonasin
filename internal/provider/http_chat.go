...
func (a HTTPChatAdapter) ValidateChatRequest(instance Instance, req openai.ChatCompletionRequest) error {
	...
	case "deepseek", "openrouter":
		...
		if instance.Type == "deepseek" {
			if err := rejectPresentFields(req, "presence_penalty", "frequency_penalty", "parallel_tool_calls"); err != nil {
				return err
			}
	...
	case "codex":
		unsupported := append(commonUnsupported, "tools", "tool_choice", "parallel_tool_calls", "logprobs", "top_logprobs", "provider_options", "max_tokens", "max_completion_tokens", "temperature", "top_p", "presence_penalty", "frequency_penalty", "stop", "response_format")
