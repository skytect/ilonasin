...
func safeDisplay(value string) string {
	return safeDisplayWithPattern(value, privacy.UnsafeDisplayString)
}
...
func safeFullWrappedDisplay(value string) string {
	return safeFullWrappedDisplayWithPattern(value, privacy.UnsafeDisplayString)
}
...
func safeWrappedDisplayWithPattern(value string, unsafe func(string) bool) string {
	value = strings.Map(func(r rune) rune {
		if unicode.IsControl(r) {
			return -1
		}
...
func safeFullWrappedDisplayWithPattern(value string, unsafe func(string) bool) string {
	value = strings.Map(func(r rune) rune {
		if unicode.IsControl(r) {
			return -1
		}
...
func safeDisplayWithPattern(value string, unsafe func(string) bool) string {
	value = strings.Map(func(r rune) rune {
		if unicode.IsControl(r) {
			return -1
		}
