...
var (
	...
	mutedStyle        = lipgloss.NewStyle().Foreground(lipgloss.Color("252"))
	...
	tabInactiveStyle  = lipgloss.NewStyle().Foreground(lipgloss.Color("159"))
	...
	emptyBarStyle     = lipgloss.NewStyle().Foreground(lipgloss.Color("244"))
	...
	paneStyle         = lipgloss.NewStyle().Border(lipgloss.NormalBorder()).BorderForeground(lipgloss.Color("67")).Padding(0, 1)
